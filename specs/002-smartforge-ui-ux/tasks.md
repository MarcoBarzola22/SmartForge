...
- [x] **T-03: Configuración de escala de espaciado estricta base 4px y breakpoints móviles**
...
- [x] **T-04: Blindaje global contra scroll horizontal y utilidades táctiles en `index.css`**
...
- [x] **T-05: Rediseño y tests unitarios de `Button.tsx`**
...
- [x] **T-06: Rediseño y tests de normalización decimal en `Input.tsx`**
...
- [x] **T-07: Implementación de `Card.tsx` rígido y modular**
...
- [x] **T-08: Implementación de `Sheet.tsx` (Bottom Sheet con bloqueo de scroll y soporte de teclado)**
...
- [x] **T-09: Implementación de `AlertDialog.tsx` para confirmación destructiva en dos pasos**
...
- [x] **T-10: Rediseño de `Toast.tsx` y `ToastContainer` sobre la Bottom Bar**
...
- [x] **T-11: Implementación de `CentralizedSpinner.tsx` y `EmptyState.tsx` en español**
...
- [x] **T-12: Rediseño de `BottomNav.tsx` con altura exacta de 64px y dianas de 48px**
...
- [x] **T-13: Implementación de `useVisualViewport.ts` para ajuste dinámico ante teclado**
...
- [x] **T-14: Implementación de `KeyboardActionBar.tsx` fijada sobre el teclado**
...
- [x] **T-15: Implementación de sub-navegación inferior (`SegmentedSubNav.tsx`)**
...
- [x] **T-16: Refactorización de `MobileLayout.tsx` integrando safe-areas y layout de 1 columna**
...
- [x] **T-17: Implementación de `ModularSetCard.tsx` con disposición modular para 320px**
...
- [x] **T-18: Implementación de `ActiveExerciseWorkspace.tsx` con Sticky Workspace**
...
- [x] **T-19: Implementación de `RestTimerBar.tsx` con Display 32px y cancelación anticipada**
...
- [x] **T-20: Implementación de truncamiento táctil reversible en nombres y notas de ejercicios**
...
- [x] **T-21: Implementación de `FilterBottomSheet.tsx` para filtros musculares**
...
- [x] **T-22: Implementación de la barra de búsqueda accesible en mitad inferior en `ExerciseCatalogPage.tsx`**
...
- [x] **T-23: Refactorización de `ProfilePage.tsx` con disposición vertical estricta**
...
- [x] **T-24: Refactorización de `RoutineEditorPage.tsx` y `CheckInModal.tsx`**
...
- [x] **T-25: Refactorización de `LoginPage.tsx` con botones apilados y dianas accesibles**
...
- [x] **T-26: Suite de tests automatizados de ratios de contraste y accesibilidad ARIA (`axe-core`)**
...
- [x] **T-27: Suite de tests responsive automatizados de cero scroll horizontal en 320px, 360px, 375px y 390px**
  - **RF cubiertos:** RF-10, CF-02, Constitución R2
...
- [x] **T-28: Auditoría de idioma español en interfaz y mensajes visibles**
